	...
	return (
		<section className="w-full h-auto py-[4rem]">
			<div className="flex flex-col items-center auto-spacing space-y-[1rem]">
				<h1 className="text-center text-whiteColor font-[600] text-4xl lg:text-2xl uppercase">
					Disponible sur tout support
				</h1>

				<div className="flex flex-col items-center">
					<p className="text-center order-1 sm:-order-1 sm:w-[80%]">
						...
						Laborum dicta velit voluptates repellat totam aliquam
						unde mollitia tempore error quibusdam delectus voluptas
						obcaecati recusandae minima vero, cupiditate eaque earum
						sunt! Eligendi, quos! Ipsam magnam amet cupiditate.
						Nulla hic minima amet facere. Numquam autem consequatur
						maiores quae magnam!
					</p>
